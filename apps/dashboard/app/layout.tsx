        ...
        <header className="border-b border-border">
          <div className="mx-auto flex max-w-6xl items-center gap-6 px-6 py-4">
            ...
            <nav className="flex items-center gap-5 text-sm text-muted">
              <Link href="/bridges" className="hover:text-text">Bridges</Link>
              <Link href="/events" className="hover:text-text">Events</Link>
              <Link href="/about" className="hover:text-text">About</Link>
              <a href="https://github.com/Hermit210/Bridge-radar-/blob/master/WHITEPAPER.md" className="hover:text-text" target="_blank" rel="noreferrer">Whitepaper</a>
              <a href="https://github.com/Hermit210/Bridge-radar-" className="hover:text-text" target="_blank" rel="noreferrer">GitHub</a>
            </nav>
